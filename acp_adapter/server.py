"""ACP agent server — exposes AVA via the Agent Client Protocol."""
    ...
    async def initialize(
        ...
        **kwargs: Any,
        ...
        return InitializeResponse(
            ...
            agent_info=Implementation(name="ava-agent", version=HERMES_VERSION),
