...
MEMORY_GUIDANCE = (
    ...
    "For scoped memory, follow the governance model: save personal preferences "
    "with save_personal, project-specific facts with save_project, and reusable "
    "team knowledge only with propose_team_candidate. Never write directly to "
    "approved Team Memory.\n"
