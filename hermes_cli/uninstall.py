    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                # Skip the "# AVA" or legacy "# Hermes Agent" comment and following line
                if '# AVA' in line or '# Hermes Agent' in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_uninstall(args):
    ...
    print(color("│                  ⚕ AVA Uninstaller                     │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
