...
_HERMES_USER_AGENT = f"ava-cli/{_HERMES_VERSION}"
...
_CODEX_ONLY_PROVIDER_IDS = frozenset({"openai-codex", "openai-api"})
_PROVIDER_MODELS = {
    "openai-codex": _codex_curated_models(),
    "openai-api": [
        "gpt-5.5",
...
CANONICAL_PROVIDERS: list[ProviderEntry] = [
    ProviderEntry("openai-codex",   "OpenAI Codex",             "OpenAI Codex (ChatGPT/Codex OAuth)"),
